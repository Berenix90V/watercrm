       ...
       <div class = "section-header">
        <h1>Lista Clienti</h1>  <!-- bootstrap class: card-header text-primary -->
        </div> <!-- end card-header-->
        ...
        // ------------------------- GESTIONE DELLA TABELLA ----------------------------//
            ...
            $db_fields = array('CL_name', 'CL_surname', 'CL_city');
            ...
            // ICONE
            $anagrafica = '<a href = "'.site_url('Registry/registry_single_view').'" class="registry-button"><span class = "registry"><i class = "fas fa-search"></i></span> <span class="text"> Visualizza Anagrafica</span></a>';
            ...
            $extracol = array(
                'actions' => '<div class="actions-button">'.$scadenziario.'</div><div class="actions-button">'.$anagrafica.'</div>',
                'status' => $status
            );
            
            $header_result = $this->Home_model->table_registry_view($db_fields, $labels, $extracol);
            

            //TEMPLATE TABELLA
            //scelgo un template dalla library tabletemplate
            $table_id = 'home_registry_table';
            $table_class = 'datatable r_order status_order';
